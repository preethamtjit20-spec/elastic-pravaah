"""Triage Agent -- MEWS-based patient severity classification for Kibana Agent Builder."""

AGENT_ID = "triage-agent"
DISPLAY_NAME = "Triage Agent"
DISPLAY_DESCRIPTION = "MEWS-based emergency triage scoring and severity assessment"
...
def definition() -> dict:
    """Return the agent definition dict for the Triage Agent."""
    return {
        "agent_id": AGENT_ID,
