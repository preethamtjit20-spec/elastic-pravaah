"""Guardian Safety Agent -- last line of defense against patient deterioration for Kibana Agent Builder."""

AGENT_ID = "guardian-agent"
DISPLAY_NAME = "Guardian Safety Agent"
DISPLAY_DESCRIPTION = "Deterioration detection with veto power - catches hidden trends other agents miss"
...
def definition() -> dict:
    """Return the agent definition dict for the Guardian Safety Agent."""
    return {
        "agent_id": AGENT_ID,
